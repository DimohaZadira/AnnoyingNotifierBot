    ...
    async def begin_notif_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            await update.message.reply_text(
                ...
                f"💡 Отправьте любое сообщение, чтобы приостановить уведомления до следующего времени начала ({start_time})\n"
...
• Если вы отвечаете на любое сообщение, уведомления приостанавливаются до следующего времени начала
...
• ⏸️ Приостановленные уведомления возобновляются в указанное время
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            active_notifications = self.notification_manager.get_active_notifications()
            if user_id in active_notifications:
                # Приостанавливаем уведомления до следующего времени начала
